...
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'PAUL@MINDTREE', '2017-09-12', 1013654, 'PAUL', NULL, NULL, NULL);
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'LEAN@MINDTREE', '2017-08-01', 1013424, 'LEAN', NULL, NULL, NULL);
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'KAMR@MINDTREE', '2017-05-21', 1015424, 'KAMR', NULL, NULL, NULL);
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'URYUI@MINDTREE', '2017-11-30', 1078624, 'URYUI', NULL, NULL, NULL);
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'TARA@MINDTREE', '2017-12-31', 1017824, 'TARA', NULL, NULL, NULL);
INSERT INTO EMPLOYEES (ID, EMAIL, JOIN_DATE, MID, NAME, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, VERSION_NUMBER) VALUES (DEFAULT, 'JAMES@MINDTREE', '2017-09-19', 1056624, 'JAMES', NULL, NULL, NULL);
